...
namespace CorePOSApi.Business.Data.context
{
    public class DbContext
    {
        ...
        {
            return "Server=tcp:turing.database.windows.net,1433;Initial Catalog=despachos;Persist Security Info=False;User ID=aesoftware;Password=artifactS20;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
        }
